...
class m160707_145431_create_doctors_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert($this->_tableName, ['name', 'photo', 'description', 'clinic_id', 'speciality_id'], [
        		...
        		['Ширшикова Ольга Викторовна', 'https://new.onedoc.ru/upload/doctors/thumb/9b/Shirshikova_Olga.jpg', 'Врач Ширшикова Ольга Викторовна - гастроэнтеролог и терапевт со стажем врачебной практики 24 года. Рейтинг на сайте onedoc.ru - 4.75 на основе 26 отзывов.', 1, 2],
        		
        		['Халецкая Варвара Александровна', 'https://new.onedoc.ru/upload/doctors/thumb/4b/Haletskaja_Varvara.jpg', 'Врач Халецкая Варвара Александровна - невролог со стажем врачебной практики 16 лет. Рейтинг на сайте onedoc.ru - 4.75 на основе 2 отзывов.', 1, 3],
